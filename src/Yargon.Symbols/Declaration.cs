...
namespace Yargon.Symbols
{
    ...
    /// </summary>
    public class Declaration<TName, TSymbol>
    {
        /// <summary>
        ...
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="Declaration{TName, TSymbol}"/> class.
        /// </summary>
        ...
        public Declaration(Symbol<TName, TSymbol> symbol, Uri document, Range name, Range range)
        {
            #region Contract
            if (symbol == null)
        ...
        #region Equality
        /// <inheritdoc />
        public bool Equals(Declaration<TName, TSymbol> other)
        {
        ...
        /// <inheritdoc />
        public override bool Equals(object obj) => Equals(obj as Declaration<TName, TSymbol>);

        /// <summary>
        /// Returns a value that indicates whether two specified <see cref="Declaration{TName, TSymbol}"/> objects are equal.
        /// </summary>
        /// <param name="left">The first object to compare.</param>
        /// <param name="right">The second object to compare.</param>
        /// <returns><see langword="true"/> if <paramref name="left"/> and <paramref name="right"/> are equal;
        /// otherwise, <see langword="false"/>.</returns>
        public static bool operator ==(Declaration<TName, TSymbol> left, Declaration<TName, TSymbol> right) => Object.Equals(left, right);

        /// <summary>
        /// Returns a value that indicates whether two specified <see cref="Declaration{TName, TSymbol}"/> objects are not equal.
        /// </summary>
        /// <param name="left">The first object to compare.</param>
        /// <param name="right">The second object to compare.</param>
        /// <returns><see langword="true"/> if <paramref name="left"/> and <paramref name="right"/> are not equal;
        /// otherwise, <see langword="false"/>.</returns>
        public static bool operator !=(Declaration<TName, TSymbol> left, Declaration<TName, TSymbol> right) => !(left == right);
        #endregion
